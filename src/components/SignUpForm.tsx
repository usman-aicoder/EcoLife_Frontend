...
import { X, Mail, Lock, Sparkles, Leaf, User, AlertCircle, Loader2 } from "lucide-react";
...
export function SignUpForm({ onClose, onSignUpSuccess, onSignIn }: SignUpFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onClose();
      onSignUpSuccess({ name: userData.name, email: userData.email });
    } catch (err: any) {
        ...
        <div className="relative p-8 sm:p-10">
          ...
          >
            <p className="text-sm text-green-600">
              No card needed — just start your green journey.
            </p>
          </motion.div>
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              >
                ...
                <circle cx="60" cy="60" r="45" fill="url(#planetGradient)" />
                <path
